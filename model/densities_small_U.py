...
from input.parameters import nu, number_occupied_bands, alpha_rand, dens, alpha_state
...
if nu == 0:
    ...
    print('parameters dens nu=0: alpha_rand=%(alpha_rand).3f, dens=%(dens)i, alpha_state=%(alpha_state).2f' % parameters_density)
